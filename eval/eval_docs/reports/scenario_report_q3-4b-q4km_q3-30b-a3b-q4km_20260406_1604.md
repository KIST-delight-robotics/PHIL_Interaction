# scenario_report_q3-4b-q4km_q3-30b-a3b-q4km_20260406_1604.json 해설 리포트

- source_json: `reports/scenario_report_q3-4b-q4km_q3-30b-a3b-q4km_20260406_1604.json`
...
| --- | --- |
| 문서 종류 | 실행 결과 리포트 |
| generated_at | 2026-04-06T16:04:14+09:00 |
| suite | scenario |
...
| 전체 결과 | 17/28 (60.7%) |
| classifier latency | avg 0.921 s, median 0.911 s, p95 0.970 s |
| planner latency | avg 2.778 s, median 2.772 s, p95 4.275 s |
| total latency | avg 3.699 s, median 3.666 s, p95 5.217 s |
...
| --- | --- |
| 전체 케이스 수 | 28 |
| JSON 리포트 | reports/scenario_report_q3-4b-q4km_q3-30b-a3b-q4km_20260406_1604.json |
| Markdown 리포트 | eval_docs/reports/scenario_report_q3-4b-q4km_q3-30b-a3b-q4km_20260406_1604.md |
| 실패 시 종료 코드 | 1 |
...
| 통과한 케이스 | scenario_01_key_in_greeting, scenario_02_key_in_intro, scenario_03_key_in_arms_out_blocked, scenario_04_key_out_play_tim, scenario_05_playing_nod_blocked, scenario_06_playing_status_question, scenario_09_key_out_right_wrist_up, scenario_10_key_out_shake_head, scenario_11_key_out_name_yes_nod, scenario_13_key_out_ready_pose, scenario_14_key_out_arms_up_wait_down, scenario_16_key_out_tongue_twister_as_joke, scenario_18_ramen_recipe_question, scenario_19_key_out_arm_up_then_nod, scenario_22_todo_greet_and_nod, scenario_26_todo_raise_left_arm_a_bit_more, scenario_27_todo_look_slightly_right |
| 실패한 케이스 | scenario_07_song_list_question, scenario_08_key_out_hurray, scenario_12_key_out_name_no_shake, scenario_15_key_out_wave_then_play_ty, scenario_17_key_out_joke_request, scenario_20_key_out_wrist_down_then_after_one_more_down, scenario_21_key_out_wrist_down_thirty_twice, scenario_23_todo_play_and_wave_greatest_showman, scenario_24_todo_unsafe_waist_turn_100, scenario_25_todo_stop_and_home_if_playing, scenario_28_todo_greet_after_play |
...
| --- | --- | --- | --- | --- |
| classifier | 0.921 s | 0.911 s | 0.970 s | scenario_11_key_out_name_yes_nod |
| planner | 2.778 s | 2.772 s | 4.275 s | scenario_07_song_list_question |
| total | 3.699 s | 3.666 s | 5.217 s | scenario_07_song_list_question |
...
- 총 28건 중 17건 통과, 11건 실패였습니다. 실패 케이스는 `scenario_07_song_list_question, scenario_08_key_out_hurray, scenario_12_key_out_name_no_shake, scenario_15_key_out_wave_then_play_ty, scenario_17_key_out_joke_request, scenario_20_key_out_wrist_down_then_after_one_more_down, scenario_21_key_out_wrist_down_thirty_twice, scenario_23_todo_play_and_wave_greatest_showman, scenario_24_todo_unsafe_waist_turn_100, scenario_25_todo_stop_and_home_if_playing, scenario_28_todo_greet_after_play`입니다.
- 가장 느린 케이스는 `scenario_07_song_list_question`였고 총 5.305 s가 걸렸습니다.
